...
contract Dao {
    ...
    constructor() {
        ...
        validTokens = [6297462134565687701562644097872457958085077774325948225928934235231645335553];
    }

    struct proposal{
        uint256 id; //proposal id
        bool exists; //proposal exists?
    ...
    function countVotes(uint256 _id) public{
        require(msg.sender == owner, "Only Owner Van Count Votes");
        require(Proposals[_id].exists, " This Proposal does not exist");
