...
import { Blockie, Tooltip, Icon, Widget, Tag, Table, Form } from 'web3uikit'
                    ...
                    <div className='widgets'>
                        <Widget info={latestVote.votesUp} title="Votes For" >
                            <div className='extraWidgetInfo'>
                                ...
                                <div className='progress'>
                                    <div className='progressPercentage' style={{ width: `${percUp}%` }}>
                                    </div>
                                </div>
                            </div>
                        </Widget>
                        <Widget info={latestVote.votesDown} title="Votes Against" >
                            <div className='extraWidgetInfo'>
                                ...
                                <div className='progress'>
                                    <div className='progressPercentage' style={{ width: `${percDown}%` }}>
                                    </div>
                                </div>
                            </div>
                        </Widget>
